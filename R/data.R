...
#'   \item{EI}{Endangerment index (proportion).}
#'   \item{EI_logit}{Logit-transformed ndangerment index (proportion).}
#'   \item{year}{Year of data.}
#'   \item{AG.SRF.TOTL.K2}{Total country surface in km^2.}
#'   \item{SP.POP.TOTL}{Total country population.}
#'   \item{area_log}{Logged total country surface.}
#'   \item{pop_log}{Logged total country population.}
#' }
#' @source
